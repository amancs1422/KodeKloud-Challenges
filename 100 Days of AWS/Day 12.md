...
## Step 6 : If you select the “xfusion-ec2” EC2 instance and access the Storage section you will find the “xfusion-volume” in attached status with device name as "/dev/sdb" fulfilling the lab requirements.
