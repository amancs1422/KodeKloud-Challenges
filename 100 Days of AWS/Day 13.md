...
For this task, create an AMI from an existing EC2 instance named devops-ec2 with the following requirement: <br>
Name of the AMI should be devops-ec2-ami, make sure AMI is in available state.
## Step 1 : Access the EC2 Dashboard as shown below in AWS Management Console.
...
## Step 2 : Find the "devops-ec2" instance from which AMI needs to be created as per the lab requirement.
...
## Step 3 : Select the "devops-ec2" instance and click on "Create Image" as shown below.
...
## Step 4 : Fill in the image name as "devops-ec2-ami" and click on "Create Image".
