...
### :clipboard: For this task, create an EC2 instance with following requirements:
...
### Step 1: Access the EC2 service in AWS Console and click on "Launch Instance" button. Fill in the instance name as per lab requirement.
...
### Step 2: Click on "Create new key pair" to create the new RSA key pair.
