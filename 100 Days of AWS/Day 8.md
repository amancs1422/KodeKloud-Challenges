...
## Step 3 : Select the instance and choose the "Change stop protection" option.
...
## Step 4 : Check mark the enable option and hit "Save".
...
## Step 5 : Validate the change is made properly by stopping the instance, you will get the following message popup denying the operation.
